...
- Returns in Resource whenever possible
- Create global utility functions for common tasks (e.g., date formatting on the frontend), but ask first
- Run linting and formatting automatically on every commit to maintain code consistency
- Automated tests are mandatory for every new feature or change
