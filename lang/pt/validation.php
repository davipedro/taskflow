...
return [
    ...
    | usadas pela classe de validação. Algumas regras têm várias versões,
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Aqui pode especificar mensagens de validação personalizadas para
    | atributos usando a convenção "attribute.rule" para nomear as linhas.
    | Isto torna rápido especificar uma linha de linguagem personalizada
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de linguagem são usadas para trocar o marcador de
    | atributo por algo mais amigável, como "Endereço de Email" em vez de
    | "email". Isto simplesmente ajuda-nos a tornar a mensagem mais expressiva.
    |
    */
